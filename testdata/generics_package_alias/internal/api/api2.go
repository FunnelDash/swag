...
import (
	myv1 "github.com/FunnelDash/swag/v3/testdata/generics_package_alias/internal/path1/v1"
	myv2 "github.com/FunnelDash/swag/v3/testdata/generics_package_alias/internal/path2/v1"
)
